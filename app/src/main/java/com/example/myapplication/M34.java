...
public class M34 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.jesussaviorpilotme);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M34.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
