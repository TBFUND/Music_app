...
public class M49 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m49);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.standingonthepromises);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M49.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
