...
public class M45 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m45);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.therenotafriend);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M45.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
