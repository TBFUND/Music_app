...
public class M32 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.jesusroseofsharon);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M32.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
