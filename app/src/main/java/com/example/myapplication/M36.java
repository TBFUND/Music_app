...
public class M36 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m36);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.thelordsmyshepherd);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M36.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
