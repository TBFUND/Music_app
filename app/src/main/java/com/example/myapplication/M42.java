...
public class M42 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m42);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.redeemed1);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M42.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
