...
public class M44 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m44);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.thisismyfatherworld);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M44.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
