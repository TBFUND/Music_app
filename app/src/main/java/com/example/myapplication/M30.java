...
public class M30 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.beautifulilsleofsomewhere);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M30.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
