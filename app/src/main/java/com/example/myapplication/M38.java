...
public class M38 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m38);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.thereisafountain);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M38.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
