...
public class M40 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.preciousmemories);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M40.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
