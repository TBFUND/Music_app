...
public class M28 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m28);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.alltojesusisurrender);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M28.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
