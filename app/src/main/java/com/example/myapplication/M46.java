...
public class M46 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m46);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.saviorgrantmerest);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M46.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
