...
public class M47 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m47);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.thechurchonefoundation);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M47.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
