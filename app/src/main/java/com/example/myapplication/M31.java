...
public class M31 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m31);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.jesuslovesme);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M31.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
