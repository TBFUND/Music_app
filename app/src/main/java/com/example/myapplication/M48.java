...
public class M48 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m48);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.thespaciousfirmament);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M48.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
