...
public class M43 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m43);
        ...
        songName.setText("");
        mPlayer = MediaPlayer.create(this, R.raw.seekingthelost);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(M43.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
